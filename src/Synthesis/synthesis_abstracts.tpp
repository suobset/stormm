...
SyValenceKit<T>::SyValenceKit(const int nvwu_in, const T coulomb_in, const T* bond_keq_in,
                              ...
                              const uint* cbnd_acc_in, const uint* angl_acc_in,
                              const uint* cdhe_acc_in, const uint* cmap_acc_in,
...
SyNonbondedKit<T, T2>::SyNonbondedKit(const int nsys_in, const UnitCellType unit_cell_in,
    ...
    coulomb{coulomb_in}, igb{igb_in}, dielectric{dielectric_in}, kappa{kappa_in},
    saltcon{saltcon_in}, gb_offset{gb_offset_in}, gb_neckscale{gb_neckscale_in},
    gb_neckcut{gb_neckcut_in}, charge{charge_in}, lj_idx{lj_idx_in}, n_lj_types{n_lj_types_in},
