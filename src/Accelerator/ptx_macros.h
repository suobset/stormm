...
#ifdef OMNI_USE_HIP
#define SHFL_DOWN(a, b)  __shfl_down_sync(0xffffffffffffffff, a, b, 64);
#define SHFL_XOR(a, b)   __shfl_xor_sync(0xffffffffffffffff, a, b, 64);
#define SHFL_UP(a, b)    __shfl_up_sync(0xffffffffffffffff, a, b, 64);
