    ...
    timer{timer_in}
{
  ...
  ic = cis_trans_groups.putHost(&int_data, tmp_cis_trans_groups, ic, warp_size_zu);
  ic = cis_trans_group_bounds.putHost(&int_data, tmp_cis_trans_group_bounds, ic, warp_size_zu);
