...
RMSDPlanReader<T>::RMSDPlanReader(const int plan_count_in, const RMSDMethod strategy_in,
                                  ...
                                  const int2* symm_ranges_in, const int* frame_counts_in,
                                  const int* atr_starts_in, const size_t* ata_starts_in) :
    ...
    symm_ranges{symm_ranges_in}, frame_counts{frame_counts_in}, atr_starts{atr_starts_in},
    ata_starts{ata_starts_in}
{}
