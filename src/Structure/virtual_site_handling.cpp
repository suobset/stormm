    ...
    case VirtualSiteKind::FIXED_4:
      {
        ...
        rj_f4[0] = (vsk.dim1[i] * (psw.xcrd[frame4_atom] - psw.xcrd[parent_atom])) - p_f2[0];
        rj_f4[1] = (vsk.dim1[i] * (psw.ycrd[frame4_atom] - psw.ycrd[parent_atom])) - p_f2[1];
        rj_f4[2] = (vsk.dim1[i] * (psw.zcrd[frame4_atom] - psw.zcrd[parent_atom])) - p_f2[2];
