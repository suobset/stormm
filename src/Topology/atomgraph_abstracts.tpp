...
ValenceKit<T>::ValenceKit(const int natom_in, const int nbond_in, const int nangl_in,
    ...
    bond_relevance{bond_relevance_in}, angl_i_atoms{angl_i_atoms_in},
    angl_j_atoms{angl_j_atoms_in}, angl_k_atoms{angl_k_atoms_in},
    angl_param_idx{angl_param_idx_in}, angl_modifiers{angl_modifiers_in},
    angl_relevance{angl_relevance_in}, dihe_i_atoms{dihe_i_atoms_in},
    dihe_j_atoms{dihe_j_atoms_in}, dihe_k_atoms{dihe_k_atoms_in}, dihe_l_atoms{dihe_l_atoms_in},
    dihe_param_idx{dihe_param_idx_in}, dihe14_param_idx{dihe14_param_idx_in},
    dihe_modifiers{dihe_modifiers_in}, infr14_i_atoms{infr14_i_atoms_in},
    infr14_l_atoms{infr14_l_atoms_in}, infr14_param_idx{infr14_param_idx_in},
    ubrd_i_atoms{ubrd_i_atoms_in}, ubrd_k_atoms{ubrd_k_atoms_in},
    ubrd_param_idx{ubrd_param_idx_in}, cimp_i_atoms{cimp_i_atoms_in},
    cimp_j_atoms{cimp_j_atoms_in}, cimp_k_atoms{cimp_k_atoms_in}, cimp_l_atoms{cimp_l_atoms_in},
    cimp_param_idx{cimp_param_idx_in}, cmap_i_atoms{cmap_i_atoms_in},
    cmap_j_atoms{cmap_j_atoms_in}, cmap_k_atoms{cmap_k_atoms_in}, cmap_l_atoms{cmap_l_atoms_in},
    cmap_m_atoms{cmap_m_atoms_in}, cmap_dim{cmap_dim_in}, cmap_surf_bounds{cmap_surf_bounds_in},
    cmap_patch_bounds{cmap_patch_bounds_in}, cmap_surf_idx{cmap_surf_idx_in},
    ubrd_keq{ubrd_keq_in}, ubrd_leq{ubrd_leq_in}, cimp_keq{cimp_keq_in}, cimp_phi{cimp_phi_in},
    cmap_surf{cmap_surf_in}, cmap_dphi{cmap_dphi_in}, cmap_dpsi{cmap_dpsi_in},
    cmap_dphi_dpsi{cmap_dphi_dpsi_in}, cmap_patches{cmap_patches_in},
...
ConstraintKit<T>::ConstraintKit(const int nsettle_in, const int nsett_param_in,
                                ...
                                const T* settle_mo_in, const T* settle_mh_in,
                                const T* settle_moh_in, const T* settle_mormt_in,
                                const T* settle_mhrmt_in, const T* settle_ra_in,
                                const T* settle_rb_in, const T* settle_rc_in,
    ...
    group_param_bounds{group_param_bounds_in}, settle_mo{settle_mo_in}, settle_mh{settle_mh_in},
    settle_moh{settle_moh_in}, settle_mormt{settle_mormt_in}, settle_mhrmt{settle_mhrmt_in},
    settle_ra{settle_ra_in}, settle_rb{settle_rb_in}, settle_rc{settle_rc_in},
    group_sq_lengths{group_sq_lengths_in}, group_inv_masses{group_inv_masses_in}
{}
