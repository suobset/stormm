...
//-------------------------------------------------------------------------------------------------
template <typename T>
ValenceKit<T>::ValenceKit(const int nbond_in, const int nangl_in, const int ndihe_in,
                          const int nbond_param_in, const int nangl_param_in,
    ...
    nbond{nbond_in}, nangl{nangl_in}, ndihe{ndihe_in}, nbond_param{nbond_param_in},
    nangl_param{nangl_param_in}, ndihe_param{ndihe_param_in}, ninfr14{ninfr14_in},
    nattn14_param{nattn14_param_in}, nubrd{nubrd_in}, ncimp{ncimp_in}, ncmap{ncmap_in},
    nubrd_param{nubrd_param_in}, ncimp_param{ncimp_param_in}, ncmap_surf{ncmap_surf_in},
    bond_keq{bond_keq_in}, bond_leq{bond_leq_in}, angl_keq{angl_keq_in}, angl_theta{angl_theta_in},
    dihe_amp{dihe_amp_in}, dihe_freq{dihe_freq_in}, dihe_phi{dihe_phi_in},
    attn14_elec{attn14_elec_in}, attn14_vdw{attn14_vdw_in}, bond_i_atoms{bond_i_atoms_in},
    bond_j_atoms{bond_j_atoms_in}, bond_param_idx{bond_param_idx_in},
    bond_modifiers{bond_modifiers_in}, angl_i_atoms{angl_i_atoms_in},
    ...
    infr14_i_atoms{infr14_i_atoms_in}, infr14_j_atoms{infr14_j_atoms_in},
...
NonbondedKit<T>::NonbondedKit(const int natom_in, const int n_q_types_in, const int n_lj_types_in,
                              ...
                              const T* ljc_14_coeff_in, const int* nb11x_in,
