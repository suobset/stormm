        ...
        for (int tj = 0; tj <= tjlim; tj++) {
          ...
          if (stij_map_index == 0) {
            ...
            for (int i = 0; i < ni_atoms; i++) {
              ...
              const double atomi_x = xcrd[atom_i];
              const double atomi_y = ycrd[atom_i];
              const double atomi_z = zcrd[atom_i];
              ...
              for (int j = 0; j < jlim; j++) {
                ...
                const double dx = xcrd[atom_j] - atomi_x;
                const double dy = ycrd[atom_j] - atomi_y;
                const double dz = zcrd[atom_j] - atomi_z;
