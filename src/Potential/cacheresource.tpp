...
CacheResourceKit<T>::CacheResourceKit(const int max_blocks_in, const int max_atoms_in,
                                      ...
                                      int* xvel_ovrf_in, int* yval_ovrf_in, int* zvel_ovrf_in,
    ...
    zcrd{zcrd_in}, xvel{xvel_in}, yvel{yvel_in}, zvel{zvel_in}, xcrd_ovrf{xfrc_ovrf_in},
    ycrd_ovrf{yfrc_ovrf_in}, zcrd_ovrf{zfrc_ovrf_in}, xvel_ovrf{xfrc_ovrf_in},
    yvel_ovrf{yfrc_ovrf_in}, zvel_ovrf{zfrc_ovrf_in}, xfrc_ovrf{xfrc_ovrf_in},
