...
//-------------------------------------------------------------------------------------------------
template <typename T>
ThermostatReader<T>::ThermostatReader(const ThermostatKind kind_in, const int natom_in,
...
//-------------------------------------------------------------------------------------------------
template <typename T>
ThermostatWriter<T>::ThermostatWriter(const ThermostatKind kind_in, const int natom_in,
                                      const int padded_natom_in, const int step_in,
                                      const int depth_in, const int init_evolution_in,
                                      const int end_evolution_in, const bool common_temperature_in,
