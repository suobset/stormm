...
///        the device.  Descriptions of parameters follow from launchCopyCoordinateXYZ() above,
...
/// \param umat_orig  Original transformation matrix taking real coordinates into fractional space
/// \param invu_orig  Original transformation matrix taking fractional coordinates into real space
/// \param bdim_orig  The original box dimensions
/// \{
...
///        Condensate, or CoordinateSeries objects).
///
/// Overloaded:
...
void launchCopyCoordinates(PsSynthesisWriter *destination, size_t dest_atom_offset, int index_dest,
                           ...
                           int index_orig, const GpuDetails &gpu);
/// \}
